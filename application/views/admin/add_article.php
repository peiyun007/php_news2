...
<div id="add_article">
<h3><a>添加文章</a></h3>
<form method="post" action="<?php echo site_url('admin/add_article_ok'); ?>">
<p><label for="article_title">标题</label><input type="text" name="article_title" id="article_title" /></p>
<p><label for="article_source">分类</label>
...
<p><label for="article_source">来源</label><input type="text" name="article_source" id="article_source" value="互联网" /></p>
<p><label for="article_author">作者</label><input type="text" name="article_author" id="article_author" value="匿名" /></p>
<p><label for="article_recommend">推荐</label><input type="checkbox" name="article_recommend" id="article_recommend" /></p>
<p><textarea style="width:700px;height:400px;" name="article_content" id="article_content" /></textarea></p>
<p><input type="submit" name="submit_article" value="发布内容" /></p>
</form>
</div>
</body>
</html>
